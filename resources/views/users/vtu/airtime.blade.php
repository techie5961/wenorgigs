           ...
           {{-- new input --}}
            ...
            <div class="column g-5 w-full">
                ...
                <div class="cont">
                    ...
                    <input oninput="CalculateTotal(this)" type="number" placeholder="Enter airtime amount(min: {{ $currency }}50)" class="inp input required" name="amount">
                </div>
            </div>
             {{-- new input --}}
            <div class="column g-5 w-full">
                ...
                <div class="cont">
                    ...
                    <input readonly value="{{ $currency }}0.00" data-fee="{{ $settings->vtu_fee ?? '' }}" type="text" placeholder="{{ $currency }}0.00" class="inp input required" name="total_amount">
                </div>
            </div>
...
@section('js')
    <script class="js">
        ...
        function CalculateTotal(element){
            try{
                let amount=element.value ?? 0;
                let fee=document.querySelector('input[name=total_amount]').dataset.fee;
                fee=parseFloat(fee);
            if(amount == ''){
                amount=0;
            }
