...
@section('main')
    <section class="w-full column g-10">
         <form action="{{ url('admins/post/marketplace/edit/product/process') }}" method="POST" onsubmit="PostRequest(event,this,MyFunc.Added)" style="border:1px solid var(--rgt-01)" action="" class="w-full bg-light br-10 p-20 column g-10">
           {{-- head --}}
            <div class="row align-center c-primary g-10">
                ...
                <strong class="desc">Edit Product</strong>
            </div>
            {{-- csrf token --}}
           ...
           {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input name="photo" accept="image/*" type="file" class="inp input">
                </div>
            </div>
            {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input value="{{ $data->name }}" name="name" placeholder="E.g Iphone 17 pro" type="text" class="inp input required">
                </div>
            </div>
             {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input value="{{ $data->category }}" name="category" placeholder="E.g Mobile Phones" type="text" class="inp input required">
                </div>
            </div>
             {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input value="{{ $data->price }}" name="price" placeholder="E.g {{ $currency }}1,500,000" type="text" class="inp input required">
                </div>
            </div>
            {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <select name="location" class="inp input required">
                        ...
                        @foreach (NigeriaStates() as $state)
                            <option {{ $data->location == $state  ? 'selected' : '' }} value="{{ $state }}">{{ $state }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input value="{{ $data->address }}" name="address" placeholder="E.g No. 5 new GRA Makurdi" type="text" class="inp input">
                </div>
            </div>
