...
@section('main')
    <section class="w-full column g-10">
        <form action="{{ url('admins/post/create/gift/code/process') }}" method="POST" onsubmit="PostRequest(event,this,Added)" style="border:1px solid var(--rgt-01)" action="" class="w-full bg-light br-10 p-20 column g-10">
           {{-- head --}}
            <div class="row align-center c-primary g-10">
                ...
                <strong class="desc">Create Gift Code</strong>
            </div>
            {{-- csrf token --}}
            ...
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input name="value" placeholder="E.g {{ $currency }}1,500" type="number" class="inp input required">
                </div>
            </div>
             {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input name="limit" placeholder="E.g 20 users" type="number" class="inp input required">
                </div>
            </div>

          
            <div style="background:rgba(0,255,0,0.1);border:1px dashed #4caf50;color:#4caf50;" class="w-full br-5 p-20 column g-10">
                The code is internally generated by the system automatically,to see and copy code click on the manage gift codes page
            </div>
